...
public class SpotifySearchLoader extends GetAudioTrackInfo {
    ...
    public AudioItem handle(String searchWord, AudioTrackFactory audioTrackFactory, SpotifyAudioSourceManager sourceManager, SpotifyApi api) {
        Track[] tracks = null;
        try {
        ...
        return new BasicAudioPlaylist("Search", audioTracks, audioTracks.get(0), true, url, null);
    }
}
